...
// On Node >= 12, util.format('%s', array) inspects the array
// ("[ 'a', 'b' ]") instead of calling toString() ("a,b") as it did on the
// Node 0.10 this library was written for; restore the old behavior since
// the SQL builders below pass arrays of columns/values to %s
const fmt = function () {
